package be.itsjust4you.drugsconsume.Config;
...
public class Config {
    ...
    public static void saveConfig1() {
        File file = new File("plugins//DrugsConsume//config.yml");
        try {
    ...
    public static void createCustomConfig2() {
        customConfigFile2 = new File(plugin.getDataFolder(), "language.yml");
    ...
    public static void saveConfig2() {
        File file = new File("plugins//DrugsConsume//language.yml");
        try {
